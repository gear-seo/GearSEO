 ...
 * @author        themebubble
 */
class RS_Latest_Works_Widget extends Widget_Base {

  public function get_name() {
    return 'rs-latest-works-widget';
  }
  ...
  public function get_icon() {
    return 'elem_icon image_gallery';
  }
  ...
  protected function _register_controls() {
    ...
    $this->add_control(
      'show_heading',
      array(
        'label'       => esc_html__('Show Heading', 'adios-addons'),
    ...
    $this->start_controls_section('section_latest_works_heading_style',
      array(
    ...
    $this->start_controls_section('section_latest_works_image_style',
      array(
    ...
    $this->start_controls_section('section_latest_works_on_hover_style',
      array(
  ...
  protected function render() { 
    ...
    echo rs_latest_works($settings, true);
  }
}
Plugin::instance()->widgets_manager->register_widget_type( new RS_Latest_Works_Widget() );